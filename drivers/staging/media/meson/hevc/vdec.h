...
struct amvdec_codec_ops {
	...
	unsigned int (*num_ctrls)(void);
	struct v4l2_ctrl_config * (*get_ctrls_cfg)(void);
};
...
struct amcodec_state {
	struct vb2_v4l2_buffer	*src;
	struct vb2_v4l2_buffer	*dst;

	struct amcodec_h264_state h264;
	// TODO add more
};
...
struct amvdec_session {
	...
	struct amcodec_state codec_state;
};
