...
static int mxl608_get_if_frequency(struct dvb_frontend *fe, u32 *frequency)
{
...
static int mxl608_get_status(struct dvb_frontend *fe, u32 *status)
{
	struct mxl608_state *state = fe->tuner_priv;
...
static int mxl608_set_params(struct dvb_frontend *fe)
{
...
static int mxl608_init(struct dvb_frontend *fe)
{
	struct mxl608_state *state = fe->tuner_priv;
	int ret;
...
static int mxl608_sleep(struct dvb_frontend *fe)
{
	struct mxl608_state *state = fe->tuner_priv;
	int ret;
...
static void mxl608_release(struct dvb_frontend *fe)
{
	struct mxl608_state *state = fe->tuner_priv;
